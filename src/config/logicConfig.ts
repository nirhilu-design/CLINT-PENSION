...
export const LOGIC_CATALOG: LogicDef[] = [
  ...
  },
  {
    ...
    severity: 'info',
    condition: 'חשיפה_מנייתית_בחיסכון < יעד_לפי_גיל − מרווח',
    products: ['gemel', 'gemelInvestment', 'education'],
    explanation:
      'מחשב את החשיפה המנייתית המשולבת במשפחת החיסכון (גמל, גמל להשקעה, השתלמות) מקובץ הקצאת הנכסים, ומשווה אותה להקצה מקובל לפי גיל: מתחת לגיל הצעיר → יעד צעיר, בין הגילאים → יעד ביניים, מעל הגיל הבוגר → יעד בוגר. חשיפה מתחת ליעד (בניכוי מרווח סבילות) פותחת הארה ניטרלית שמאירה את הפער ומזכירה שמיקוד הגדלת המניות עדיף בנכסי פרישה ולא בהשתלמות נזילה — מפנה לבעל רישיון, אינה מנחה מעבר מסלול.',
    params: [
