...
export const LOGIC_CATALOG: LogicDef[] = [
  {
    ...
    products: ['managers'],
    explanation:
      'בוחן את כל דורות ביטוח המנהלים (לפני 2001, 2001–2004, 2004–2013, 2013 ואילך) — אין יותר חסימה של הדור הישן. לכל פוליסה הארה ניטרלית: לאיזה דור היא שייכת והאם דווח מקדם קצבה מובטח.',
    params: [],
  },
  {
    id: 'cost',
