...
// Statutory minimums under the mandatory-pension extension order (צו הרחבה)
export const MIN_EMPLOYEE_RATE = 6.0 // תגמולי עובד
export const MIN_EMPLOYER_RATE = 6.5 // תגמולי מעביד
export const MIN_SEVERANCE_RATE = 6.0 // פיצויים (מלא 8.33%)
