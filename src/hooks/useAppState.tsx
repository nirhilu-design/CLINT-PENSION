...
export type Step = 'upload' | 'form' | 'dashboard' | 'product' | 'summary' | 'advisor' | 'rules' | 'personal'
...
function reducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    case 'GO_PERSONAL':
      return { ...state, step: 'personal', selectedProduct: null, selectedPolicyNumber: null }
